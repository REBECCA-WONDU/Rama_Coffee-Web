        ...
        <main className="min-h-screen bg-[#0f1c15] text-white font-inter flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center px-4 pt-32 pb-20">
                <div className="max-w-md w-full bg-[#1a2e23] rounded-[3rem] p-10 border border-white/5 shadow-2xl relative overflow-hidden">
                    {/* Decorative element */}
                    <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-rama-gold/5 rounded-full blur-3xl"></div>
                    ...
                    <div className="relative z-10 text-center mb-10">
                        ...
                        <h1 className="text-4xl font-black uppercase tracking-tighter mb-2">Create <span className="text-rama-gold">Account</span></h1>
                        <p className="text-white/40 text-xs uppercase tracking-[0.2em]">Join the premium coffee community</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-rama-gold/50" />
                                <input
                                    required
                                    type="text"
                                    value={name}
                    ...
                    <div className="mt-10 text-center relative z-10">
                        <p className="text-white/40 text-[10px] uppercase tracking-widest mb-4">Already have an account?</p>
                        <Link href="/login" className="text-rama-gold font-black text-sm uppercase tracking-widest hover:text-white transition-colors">
                            Log In Here
                        </Link>
                    </div>
                </div>
