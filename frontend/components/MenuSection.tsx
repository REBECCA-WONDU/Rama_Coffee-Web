    ...
    return (
        <section id="menu" className="py-24 bg-rama-dark text-rama-cream relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    {menuItems.map((item, idx) => (
                        <motion.div 
                            ...
                            className="flex justify-between items-end border-b border-rama-cream/10 pb-4 group hover:border-rama-gold/50 transition-colors"
                        >
                            <div>
                ...
                >
                    <Link href="/#menu" className="inline-block border border-rama-gold text-rama-gold px-8 py-3 rounded-full hover:bg-rama-gold hover:text-rama-dark transition-colors font-semibold">
                        View Full Menu
                    </Link>
                </motion.div>
            </div>
